...
- Index entries store `hash_crc32` (IEEE CRC32 over the `chain-types` canonical `TransactionView::hash()` value) as a no-alloc lookup/replenishment fingerprint, not CRC32 of serialized transaction bytes.
